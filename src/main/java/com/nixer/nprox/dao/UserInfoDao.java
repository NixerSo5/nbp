...
import com.nixer.nprox.entity.common.UserInfo;
import com.nixer.nprox.entity.common.SuperLoginDto;
...
public interface UserInfoDao {
    ...
    UserInfo findByPhone(String bindcode);

    UserInfo findByEmail(String bindcode);

    void updateLastIpAndTime(SuperLoginDto superLoginDto);
}
